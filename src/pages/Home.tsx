  ...
  return (
    <>
      <section className="hero-bg relative isolate overflow-hidden text-white">
        {/* camadas decorativas */}
        <div
          className="pattern-diamonds absolute inset-0 -z-10 opacity-[0.07] [mask-image:radial-gradient(70%_80%_at_20%_40%,black,transparent)]"
          aria-hidden
        />
        <div className="animate-glow absolute top-[8%] left-[-10%] -z-10 h-80 w-80 rounded-full bg-[#f59e0b]/15 blur-3xl md:left-[2%] md:h-[28rem] md:w-[28rem]" aria-hidden />
        ...
        <div className="mx-auto max-w-5xl px-4 pt-10 pb-20 md:pt-16 md:pb-28">
          ...
          <div className="animate-fade-up mt-8 [animation-delay:240ms] md:mt-10">
