...
const pt = {
  ...
  'home.videos.sub': 'Vídeos do evento',
  ...
  'home.stat.venues': 'Locais',
  'agenda.kicker': 'Programa oficial',
  'agenda.range': '24 – 26 Setembro 2026 · Maputo',
  'agenda.today': 'Hoje',
  ...
  'kind.culture': 'Cultura',
  'kind.awards': 'Prémios',
  'kind.logistics': 'Protocolo',
  'kind.excursion': 'Visita',
  ...
  'video.admin.fromOther': 'Adicionado no álbum',
  'video.admin.otherHint': 'Para editar, use o admin do álbum.',
...
const en: Record<Key, string> = {
  ...
  'agenda.kicker': 'Official programme',
  'agenda.range': '24 – 26 September 2026 · Maputo',
  'agenda.today': 'Today',
  ...
  'kind.awards': 'Awards',
  'kind.logistics': 'Protocol',
  'kind.excursion': 'Visit',
  ...
  'gallery.other': 'Other moments',
  'video.title': 'Videos',
  'video.empty': 'No videos yet. Check back soon!',
  'video.play': 'Watch video',
  'video.admin.add': 'Add a YouTube video',
  'video.admin.hint': 'The video appears in the website gallery and in the photo album.',
  ...
  'video.admin.fromOther': 'Added in the album',
  'video.admin.otherHint': 'To edit it, use the album admin.',
